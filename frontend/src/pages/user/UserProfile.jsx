  ...
  return (
    <div className="min-h-screen bg-gray-900 py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to="/user/dashboard" className="inline-flex items-center text-blue-400 hover:text-blue-300 mb-6">
          ...
          <div className="px-8 py-6 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-3 p-4 bg-gray-700 rounded-lg">
                ...
                <span className="text-white text-lg">{profile?.companyName}</span>
              </div>
            </div>
